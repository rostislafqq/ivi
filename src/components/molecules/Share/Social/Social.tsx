...
export const Social: React.FC = () => (
	<List className={styles.social} tag="ul">
		...
		<ListItem>
			<IconButton className={styles.social__btn} href="https://ok.ru/ivi.ru" variant="secondary" size="normal">
		...
		<ListItem>
			<IconButton className={styles.social__btn} href="https://vb.me/a0544c" variant="secondary" size="normal">
