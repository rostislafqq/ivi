...
export const FilmCardLoaded: React.FC<FilmCardProps> = ({ name, preview, href, status, className, ...props }) => {
	...
	return (
		<div
			...
			{...props}
		>
			<Link className={styles['card-loaded__link']} href={href} data-testid="film-card__link" />
			<div
